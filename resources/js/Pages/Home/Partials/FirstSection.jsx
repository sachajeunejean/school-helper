...
export default function FirstSection({
    ...
    return (
        <div
            className={`flex justify-center items-center pb-8 2xl:py-28 ${background}  min-h-[calc(100vh-100px)]`}
        >
            <div className="CONTAINER grid xl:grid-cols-2 w-11/12 lg:w-3/4 mx-auto ">
                ...
                >
                    ...
                    <div className="hidden xl:flex flex-col xl:flex-row  justify-around my-8 xl:my-14 pt-10">
