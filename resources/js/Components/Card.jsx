...
export default function Card({ title, author, chapter, category, imgSrc }) {
    return (
        <div className="mt-6 mb-16 bg-gray-300 mx-auto max-w-sm rounded-xl shadow-xl hover:scale-[1.025] transition duration-500 cursor-grab active:cursor-grabbing">
            <div
                className={`w-full rounded-t-xl shadow-xl h-36 cursor-pointer bg-[url('${imgSrc}')] bg-cover relative flex items-center before:absolute before:bg-[rgba(0,0,0,0.7)] before:top-0 before:right-0 before:bottom-0 before:left-0 before:rounded-t-xl`}
            >
